...
const Marketplace = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Skill Marketplace</h1>
        <p className="text-xl text-gray-600">Discover amazing skills from our community of talented individuals</p>
      </div>
      ...
      <div className="mb-8 space-y-4 md:space-y-0 md:flex md:gap-4 md:items-center">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="pl-12 rounded-2xl border-2 border-gray-200 focus:border-primary h-12 bg-white text-gray-900"
          />
        </div>
        
        <Select value={selectedCategory} onValueChange={setSelectedCategory}>
          <SelectTrigger className="w-full md:w-48 rounded-2xl border-2 border-gray-200 h-12 bg-white text-gray-900">
        ...
        <Button variant="outline" className="rounded-2xl border-2 h-12 px-6 bg-white text-gray-900 border-gray-200">
          Filters
        </Button>
      </div>
