      ...
      <div className="mb-8 space-y-4 md:space-y-0 md:flex md:gap-4 md:items-center">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="pl-12 rounded-2xl border-2 border-gray-200 focus:border-primary h-12"
          />
        </div>
        
        <Select value={selectedCategory} onValueChange={setSelectedCategory}>
          <SelectTrigger className="w-full md:w-48 rounded-2xl border-2 border-gray-200 h-12">
            <SelectValue placeholder="Category" />
          </SelectTrigger>
          <SelectContent className="bg-white border-2 border-gray-200 rounded-xl">
            {categories.map((category) => (
              <SelectItem key={category} value={category} className="hover:bg-sketch-gray">
        ...
        <Button variant="outline" className="rounded-2xl border-2 h-12 px-6">
          Filters
        </Button>
      </div>
